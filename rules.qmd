...
-   An Excel form, in which the outcome of each game has to be forecasted, estimates, guessed, place-your-verb-here. Click here to download the [Excel from.](files/world_cup_2024.xlsx)

The excel form consists of **48** games in the group stage and **32** games in the knockout stage. The schedule for the 48 group stage games is set and those games are specified on the left side of the form.
...
-   Points are *earned* for guessing the correct outcome of each of the games in the group stage. There are 48 games in the group stage Each correct answer is worth **25** points, for a total of **1200** points
...
| Group stages          | 25                  | 48          | 1200                 |
| Knockout stages       | 60                  | 32          | 1920                 |
| Winner                | 200                 | 1           | 200                  |
| silver                | 100                 | 1           | 100                  |
| btonze                | 70                  | 1           | 70                   |

The theoretical top score is therefore **4000** points.
